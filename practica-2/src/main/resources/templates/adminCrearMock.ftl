                ...
                <div class="sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="mt-4 text-sm text-gray-500">
                            ...
                            <#if datos??>
                                <form name="myForm" role="form" action="/admin/mock?id=${datos.getId()}" method="POST" onsubmit="return validateForm()">
...
<#--                                               placeholder="Json Web Token" required />-->
                                        <#if datos.getJwt()??>
                                            <input type="checkbox" id="jwt" name="jwt" value="jwt" checked class="ring-0 outline-none py-2 border-b border-b-sky-500 accent-sky-600">
                                        <#else>
                                            <input type="checkbox" id="jwt" name="jwt" value="jwt" class="ring-0 outline-none py-2 border-b border-b-sky-500 accent-sky-600">
                                        </#if>
