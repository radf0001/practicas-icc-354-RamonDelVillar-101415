        ...
        <nav class="border-b border-opacity-25 border-sky-300 bg-sky-600"
                    ...
                    <div class="flex items-center px-2 lg:px-0">
                        <div class="hidden sm:block">
                            <div class="flex space-x-4">
                                ...
                                <a href="/admin/mocks"
                                   class="px-3 py-2 text-sm font-medium text-white rounded-md bg-sky-700">Mocks</a>
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <a href="/admin/mocks"
                       class="block px-3 py-2 text-base font-medium text-white rounded-md bg-sky-700">Mocks</a>
                </div>
                                    ...
                                    <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                                        <div class="flex gap-x-4">
                                            <div class="flex-auto min-w-0">
                                                <p class="text-sm font-semibold leading-6 text-gray-900">
                                                    <a href="http://${hostname}:${port}/mock/${mock.getRuta()}" target="_blank" rel="noopener noreferrer">
                                                        <span class="absolute inset-x-0 bottom-0 -top-px"></span>
                                                        ${mock.getNombre()}
                                                    </a>
                                                </p>
                                                <p class="flex mt-1 text-xs leading-5 text-white">
                                                    <span class="relative truncate bg-emerald-600 rounded-lg">&nbsp;${mock.getCodigo()}&nbsp;</span>&nbsp;
                                                    <span class="relative truncate bg-sky-600 rounded-lg">&nbsp;${mock.getContentType()}&nbsp;</span>&nbsp;
                                        ...
                                        <#if titulo == "Mis Mocks">
                                            <div class="flex flex-col md:flex-row md:justify-center">
                                                ...
                                                <a href="/admin/borrarMock/${mock.getId()}" type="button" onclick="return confirm('Desea eliminar este mock?');"
