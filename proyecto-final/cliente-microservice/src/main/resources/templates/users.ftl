    ...
    <nav class="border-b border-opacity-25 border-sky-300 bg-sky-600"
            ...
            <div class="hidden sm:block">
              <div class="flex space-x-4">
                ...
                <a href="/admin/purchase"
                   class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Compras</a>
              </div>
            </div>
          </div>
      ...
      <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <a href="/admin/purchase"
             class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Compras</a>
        </div>
          ...
          <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
              <p class="mt-2 text-sm text-gray-600">
                Una lista con todos los usuarios. (Presione cualquier usuario para ver sus compras).
              </p>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
              <a href="/admin/user/create-update" type="button"
                ...
                <#list usuarios as user>
                  <li class="relative flex justify-between px-4 py-5 gap-x-6 sm:px-6 lg:px-8">
                    <div class="flex gap-x-4">
                      ...
                      <div class="flex-auto min-w-0">
                        <p class="text-sm font-semibold leading-6 text-gray-900">
                          <a href="/admin/purchase?id=${user.getId()}">
                            <span class="absolute inset-x-0 bottom-0 -top-px"></span>
                            ${user.getNombre()} ${user.getApellido()}
                          </a>
                        </p>
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a href="/admin/purchase?id=${user.getId()}" class="relative truncate hover:underline">
                            ${user.getEmail()}
                          </a>
                        </p>
                      </div>
                    ...
                    <div class="flex flex-col md:flex-row md:justify-center">
                      <a href="/admin/user/create-update?id=${user.getId()}" type="button"
                      ...
                      <a href="/admin/user/delete/${user.getId()}" onclick="return confirm('Esta seguro que desea borrar este usuario?');" type="button"
