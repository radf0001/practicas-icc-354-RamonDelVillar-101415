        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
              <a href="/admin/pack/create-update" type="button"
                    ...
                    <tr>
                      ...
                      <td class="whitespace-nowrap px-2 py-4 text-sm text-gray-500">
                        <div class="flex-col md:flex-row md:justify-center">
                          <a href="/admin/pack/create-update?id=${pack.getId()}" type="button"
                          ...
                          <a href="/admin/pack/delete/${pack.getId()}" onclick="return confirm('Esta seguro que desea borrar este paquete?');" type="button"
