                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="mt-4 text-sm text-gray-500">
                            ...
                            <form
                                    ...
                                    <#--                                    action="/cliente/purchase"-->
                                    method="POST">

                                <input type="hidden" name="cmd" value="_xclick">
                                <input type="hidden" name="business" value="sb-eeyys15229325@business.example.com">
...
<#--                                <input type="hidden" name="rm" value="1"> <!-- Indicando que haga un redirect por el metodo POST &ndash;&gt;-->
                                <input type="hidden" name="return" value="http://localhost:8181/cliente/procesarCompraPaypal">
                                <input type="hidden" name="cancel_return" value="http://localhost:8181/cliente/purchase/${datos.getId()}">
