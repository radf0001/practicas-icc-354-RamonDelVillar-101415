        ...
        <nav class="border-b border-opacity-25 border-sky-300 bg-sky-600"
                    ...
                    <div class="flex items-center px-2 lg:px-0">
                        <div class="hidden sm:block">
                            <div class="flex space-x-4">
                                ...
                                <a href="#"
                                   class="px-3 py-2 text-sm font-medium text-white rounded-md bg-sky-700">Trabajos Disponibles</a>
                                <a href="/empleado/mine"
                                   class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Mis Trabajos</a>
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
                <div class="pt-2 pb-3 space-y-1">
                    <a href="#"
                       class="block px-3 py-2 text-base font-medium text-white rounded-md bg-sky-700">Trabajos Disponibles</a>
                    <a href="/empleado/mine"
                       class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Mis Trabajos</a>
                </div>
                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <p class="mt-2 text-sm text-gray-600">
                                Una lista con todos los trabajos disponibles.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <#list compras as purchase>
                                        <tr>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.getId()}
                                            </td>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.getIdCliente()}
                                            </td>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.getIdPaquete()}
                                            </td>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.getIdEmpleado()}
                                            </td>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.getFechaEvento()}
                                            </td>
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                                                ${purchase.isEmpleado()?string('yes', 'no')}
                                            </td>
                                            <td class="whitespace-nowrap px-2 py-4 text-sm text-gray-500">
                                                <div class="flex-col md:flex-row md:justify-center">
                                                    <a href="/empleado/assign/${purchase.getId()}" type="button" onclick="return confirm('Esta seguro que desea asignarse este trabajo?');"
