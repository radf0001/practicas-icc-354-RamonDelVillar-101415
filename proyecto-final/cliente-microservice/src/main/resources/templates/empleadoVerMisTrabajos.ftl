        ...
        <nav class="border-b border-opacity-25 border-sky-300 bg-sky-600"
                    ...
                    <div class="flex items-center px-2 lg:px-0">
                        <div class="hidden sm:block">
                            <div class="flex space-x-4">
                                ...
                                <a href="/empleado/free"
                                   class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Trabajos Disponibles</a>
                                <a href="#"
                                   class="px-3 py-2 text-sm font-medium text-white rounded-md bg-sky-700">Mis Trabajos</a>
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
                <div class="pt-2 pb-3 space-y-1">
                    <a href="/empleado/free"
                       class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Trabajos Disponibles</a>
                    <a href="/#"
                       class="block px-3 py-2 text-base font-medium text-white rounded-md bg-sky-700">Mis Trabajos</a>
                </div>
                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <p class="mt-2 text-sm text-gray-600">
                                Una lista con todos mis trabajos.
                            </p>
                        </div>
                    </div>
